...
const NewChatButton = ({handleSetSelectedChat}) => {
  const handleChooseNewChat=()=>{
    console.log("clicked ra puke");
    handleSetSelectedChat("new")
  }
  return (
    <div onClick={handleChooseNewChat} className="m-2 lg:m-1.5 h-11 border border-gray-400 rounded-lg transition duration-400 text-white flex items-center hover:opacity-50 cursor-pointer">
